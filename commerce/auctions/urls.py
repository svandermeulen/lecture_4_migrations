...
urlpatterns = [
    ...
    path("wishlist", views.watch_list_view, name="watchlist"),
    path("add-to-wishlist/<idtitle:listing_id>", views.add_to_watchlist, name="add_to_watchlist"),
    path("remove-from-wishlist/<idtitle:listing_id>", views.remove_from_watchlist, name="remove_from_watchlist"),
